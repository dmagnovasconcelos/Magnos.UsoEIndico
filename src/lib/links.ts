...
export const links: LinkConfig[] = [
  ...
  },
  {
    ...
    url: "https://meli.la/2FJwnDi",
    platform: "MERCADO_LIVRE",
    categories: ["Tech"],
    featured: true,
    verifiedAt: "2026-09-21",
    verificationNote: "Verificado 4x pelo método do container do botão \"Ir para produto\" — destino estável em MLB4736039179. ATENÇÃO: o Danilo mandou este link com o título do Basike 1,8m (o item tripe-para-celular-portatil-1-7m-universal-bastao), mas o link entrega OUTRO produto, mais barato. Cadastrado pelo que o clique realmente abre.",
    title: "Tripé De 180 Cm Para Bastão De Selfie De Celular Portátil Preto",
    image: "https://http2.mlstatic.com/D_Q_NP_2X_633553-MLB114685122333_072026-V.webp",
    price: 72.75,
    originalPrice: 105,
  },
  {
